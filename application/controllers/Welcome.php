...
class Welcome extends CI_Controller { 
    ...
    public function staffteraktif(){
        ...
        if($kode_user=="U-KEPSEK"){
            $siswa = $this->db->query("CALL `logteraktiv_allstaff`()")->row_array(); 
            echo '<b>Staff</b> Teraktif '.$siswa['bulan'].' '.$siswa['tahun'].' : <b>'.$siswa['nama_karyawan'].'</b>';
        }else{
            $siswa = $this->db->query("CALL `logteraktiv_allguru`()")->row_array(); 
            echo '<b>Guru</b> Teraktif '.$siswa['bulan'].' '.$siswa['tahun'].' : <b>'.$siswa['nama_karyawan'].'</b>';
        }
    }
    public function siswateraktif(){
        $siswa = $this->db->query("CALL `logteraktiv_allsiswa`()")->row_array(); 
        echo '<b>Siswa</b> Teraktif '.$siswa['bulan'].' '.$siswa['tahun'].' : <b>'.$siswa['nama_siswa'].'</b>';
    }
